...
(async () => {
  try {
    ...
    const html = renderTemplate5(data, { meta: { title: 'Snapshot Test' } }, clientBundleUrl);
    ...
    const server = app.listen(port, async () => {
      ...
      const snapshotPath = path.resolve(snapshotDir, 'template5-published.html');
    ...
    console.error('Error running publish sim for template5:', err);
    process.exit(2);
  }
})();
